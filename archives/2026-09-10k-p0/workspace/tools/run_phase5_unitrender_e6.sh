...
# Canonical E6 entrypoint.
#
# The underlying attribution runner creates the complete forensic run directory
# and legacy ZIP. This wrapper promotes that ZIP to the explicit Raw Forensic
# Package name, then builds a Compact Evidence Package for normal review.
...
[[ -f "$LEGACY_ZIP" ]] || { echo "ERROR: missing raw ZIP from attribution runner: $LEGACY_ZIP"; exit 2; }

# Rename only; bytes and SHA256 remain unchanged.
...
echo
echo "================================================================================================"
echo "STAR two-tier evidence packages"
echo "================================================================================================"
