...
# Canonical E6-1 entrypoint: formal production A/B + two-tier evidence packages.
...
bash tools/run_phase5_unitrender_e6_1_production_ab.sh
...
[[ -f "$LEGACY_ZIP" ]] || { echo "ERROR: missing raw staging ZIP: $LEGACY_ZIP"; exit 2; }
...
echo
echo "================================================================================================"
echo "STAR E6-1 two-tier evidence packages"
echo "================================================================================================"
